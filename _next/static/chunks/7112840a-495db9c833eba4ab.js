"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(t,e,i){i.d(e,{ad:function(){return tl}});var s,r,n,o,h=i(5816),l=i(8463),a=i(3333),u=i(4444),c=i(5062);i(4489),i(3454),i(1876).Buffer;let d="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let f="10.12.0",g=new a.Yd("@firebase/firestore");function m(t,...e){if(g.logLevel<=a.in.DEBUG){let i=e.map(y);g.debug(`Firestore (${f}): ${t}`,...i)}}function E(t,...e){if(g.logLevel<=a.in.ERROR){let i=e.map(y);g.error(`Firestore (${f}): ${t}`,...i)}}function y(t){if("string"==typeof t)return t;try{/**
 * @license
